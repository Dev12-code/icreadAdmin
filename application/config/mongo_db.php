...
$config['mongo_db']['default']['hostname'] = 'members.br06s.mongodb.net';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'icered_admin';
$config['mongo_db']['default']['password'] = 'kjaYkKQeyPtDj6qy';
